...
export default function Tabla({data, setRutinas, obtener_rutinas, alumnoId, goals, estados}){
    ...
    const columns = [
        ...
        },
        {
            ...
            cell: ({ row }) => (
              <div className="lowercase">{row.original.goal.name}</div>
            ),
          },
        {
        ...
        },
        {
          ...
          cell: ({ row }) => (
            <div className="capitalize">{/* <ModalEstado row={row.original} planId={row.getValue("id")} estados={estados} obtener_planes={obtener_planes} alumnoId={alumnoId}/> */}
            <ModalEstadoRutina row={row.original} rutinaId={row.getValue("id")} estados={estados} alumnoId={alumnoId} obtener_rutinas={obtener_rutinas}/>
            </div>
          ),
        },
        {
        ...
        },
        {
          ...
          name: "Borrar",
          nombre: "Borrar",
          header: () => <div className="text-left">Borrar</div>
          ,
          cell: ({ row }) => (
            <div className="capitalize"><Button variant="destructive" onClick={(e)=>borrar(row.original.id)} disabled={loading}>Borrar</Button></div>
          ),
        },
      ];
        ...
        <section className="flex flex-row flex-1 justify-center">
          <div className="w-full">
            <div className="flex items-center py-4">
              ...
              <ModalCrearRutina alumnoId={alumnoId} goals={goals} obtener_rutinas={obtener_rutinas} setRutinas={setRutinas}/>
              <DropdownMenu>
